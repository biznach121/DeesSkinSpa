...
export const brand: Brand = {
  name: "Dee's Skin Spa",
  shortName: "Dee's Skin Spa",
  microTag: "FLAWLESS SKIN, EXPERT HANDS",
  description:
    "A specialist skin spa in Lapaz, Accra — facials, stretch mark and scar treatment, tattoo removal and laser care, delivered with clinical precision and a gentle touch.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0596207153",
    phoneTel: "+233596207153",
    textPhone: "0596207153",
    textPhoneTel: "+233596207153",
    email: "hello@deesskinspa.test",
    privacyEmail: "privacy@deesskinspa.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@dees.skin.spa", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "clear skin,\nrenewed confidence.\nFlawless skin, expert hands.",
    subtitle:
      "Facials, scar and stretch-mark treatment, and advanced laser care in Lapaz — book your consultation today",
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "That is the gap Dee's Skin Spa was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Dee's Skin Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Dee's Skin Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Dee's Skin Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Dee's Skin Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Dee's Skin Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Dee's Skin Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Dee's Skin Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Dee's Skin Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Dee's Skin Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Dee's Skin Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@dees.skin.spa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783451776/stage4/spa_deesskinspa/tiktok_0.mp4",
        alt: "Dee's Skin Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783451779/stage4/spa_deesskinspa/tiktok_1.mp4",
        alt: "Dee's Skin Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783451783/stage4/spa_deesskinspa/tiktok_2.mp4",
        alt: "Dee's Skin Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Dee's Skin Spa self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Dee's Skin Spa studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Dee's Skin Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Dee's Skin Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0596207153 and text 0596207153 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0596207153, text 0596207153, or message @dees.skin.spa on Instagram." },
          ...
          { q: "Where are you located?", a: "Dee's Skin Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@deesskinspa.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Dee's Skin Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@deesskinspa.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Dee's Skin Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@deesskinspa.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Dee's Skin Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0596207153", href: "tel:+233596207153" },
      { label: "Text", value: "0596207153", href: "sms:+233596207153" },
      { label: "Instagram", value: "@dees.skin.spa", href: "https://www.tiktok.com/@dees.skin.spa" },
    ],
  },
  ...
  footer: {
    blurb:
      "Dee's Skin Spa in Accra — flawless skin, expert hands.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@dees.skin.spa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0596207153", href: "tel:+233596207153" },
          { label: "Text 0596207153", href: "sms:+233596207153" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Dee's Skin Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
