...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#3e3780] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#434091]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(36, 33, 85,0.58),rgba(43, 41, 119,0.22)_43%,rgba(39, 36, 87,0.34)),linear-gradient(0deg,rgba(20, 19, 44,0.18),rgba(20, 19, 44,0.08))]" />
