...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783444640/stage4/spa_deesskinspa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Dee's Skin Spa - Flawless skin, expert hands">
        <Image
          src={src}
          alt="Dee's Skin Spa - Flawless skin, expert hands"
          fill
